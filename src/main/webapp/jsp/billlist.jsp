...
<div class="right">
    ...
    <div class="search">
        <form method="get" action="${pageContext.request.contextPath }/jsp/bill">
            ...
            <span>商品名称：</span>
            <input name="queryProductName" type="text" value="${sessionScope.queryProductName}">
            ...
            <select name="queryProviderId">
                <c:if test="${sessionScope.providerList != null }">
                    ...
                    <c:forEach var="provider" items="${sessionScope.providerList}">
                        <option
                                <c:if test="${provider.id == sessionScope.queryProviderId }">selected="selected"</c:if>
            ...
            <select name="queryIsPayment">
                <option value="0">--请选择--</option>
                <option value="1" ${sessionScope.queryIsPayment == 1 ? "selected=\"selected\"":"" }>未付款</option>
                <option value="2" ${sessionScope.queryIsPayment == 2 ? "selected=\"selected\"":"" }>已付款</option>
            </select>
    ...
    <table class="providerTable" cellpadding="0" cellspacing="0">
        ...
        <c:forEach var="bill" items="${sessionScope.billList}" varStatus="status">
            <tr>
                <td>
