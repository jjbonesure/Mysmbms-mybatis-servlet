...
<div class="right">
        ...
        <div class="search">
        	<form method="get" action="${pageContext.request.contextPath }/jsp/provider">
				<input name="method" value="query" type="hidden">
				<span>供应商编码：</span>
				<input name="queryProCode" type="text" value="${sessionScope.queryProCode}">
				
				<span>供应商名称：</span>
				<input name="queryProName" type="text" value="${sessionScope.queryProName}">
        ...
        <table class="providerTable" cellpadding="0" cellspacing="0">
            ...
            <c:forEach var="provider" items="${sessionScope.providerList }" varStatus="status">
				<tr>
					<td>
